...
const PublicProfilePage = ({ andrewID }) => {
  ...
  return (
    <div style={{ 
      ...
      <h2 style={{ 
        ...
        {userStats.displayName || andrewID}'s Profile
      </h2>
      ...
      <div style={{ 
        ...
        <img 
          src={userStats.photoURL || `https://ui-avatars.com/api/?name=${andrewID}&background=b91c1c&color=fff`} 
          alt="profile" 
          style={{ 
            width: "80px", 
            height: "80px", 
        ...
        <div style={{ flex: 1 }}>
          <h3 style={{ 
            ...
            {userStats.displayName || andrewID}
          </h3>
          <p style={{ 
            color: "#6b7280", 
            fontSize: "14px", 
